...
const CallDetails = () => {
  ...
  return (
    <Styles>
    <div className='body'>
      <div className='question-container'><h2 className='question-title'>Call Details for ID: {callId}</h2></div>
      <div className='question-container2'><h1 className='question-title'>Call Summary:</h1><p style={{textSpacing:'1.6em', fontSize:'25px'}}>{call.call_analysis.call_summary || 'No summary available'}</p>
      </div>
      <div className='project-container'>
      <div className='question-container'>
      <h3 style={{margin:'20px'}}>Transcript:</h3></div>
      <pre style={{margin:'10px auto', padding:'20px 2px', fontSize:'1.9em', textSpacing:'1em', fontWeight:'bold', color:'red'}}>{callTranscript}</pre></div>
